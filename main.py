...
if __name__ == '__main__':
    ...
    email = Email('smtp.gmail.com', 'email@gmail.com', "password", ['email2@gmail.com'], 'Парсинг Озона',
                  f"Запрос пользователя: {user_query}\nВ файле {len(data)+2} строк" + get_end(
                      len(data)+2))  # заменить email@gmail.com на почту отправителя,
